...
export const defaultAttraction: Attraction = {
	...
	long_description_html: `<p style="font-size: 24px; font-weight: 400;">The Museum of the Future is a landmark devoted to innovative and futuristic ideologies. Located in the Financial District of Dubai, UAE.</p>
<br />
<br />
...
<div />`,
	first_text_html: `<p><span style="font-size: 30px;"><strong><strong>In our experience,</strong></strong></span></p>
...
<p><span style="font-size: 16px;">What&apos;s more, all age groups are welcome here. Children aged three to 10 can enjoy an open-world experience at the Future Heroes environment, a dedicated area designed to encourage little ones to tap into their potential. Guests also ought to make a stop at the viewing deck on level two &ndash; nestled within the museum&apos;s &apos;void&apos;, it provides an up-close experience of the facade&apos;s smooth inner shell, alongside panoramic vistas of Dubai&apos;s fast-paced urban centre.</span></p>`,
	second_text_html: `<p><span style="font-size: 36px;">Museum of the Future architecture and design</span></p>
<p><br></p>
...
<br><br>Please visit rta.ae for </span><span style="font-size: 16px;"><a href="https://google.com" target="_blank" rel="noopener noreferrer"><span style="color: rgb(219, 39, 119);">detailed public transportation schedules.<br></span></a></span><span style="font-size: 16px;"><br><br>Alternatively, If you&apos;re driving, take exit 51 from Sheikh Zayed Rd/E11. Nearby landmarks include Jumeirah Emirates Towers and DIFC Gate Village. Get a preview of your entire trip on Google Maps.&nbsp;</span>
<p><br></p>`,
}

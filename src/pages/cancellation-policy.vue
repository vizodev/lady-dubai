<template>
	...
	<img
		:src="cancellationPolicyData?.banner"
		alt="Why us Banner"
	...
	<div class="relative">
		...
		<div class="page-padding pt-[47px] relative z-10 mb-16 z-10">
			...
			<p class="font-roboto-serif font-bold text-5xl sm:text-7xl mb-16">
				{{ cancellationPolicyData?.title[locale] }}
			</p>

			<div
				v-html="cancellationPolicyData?.text_html[locale]"
...
// Page data
const { cancellationPolicyData } = storeToRefs(cancellationPolicyPageStore)
